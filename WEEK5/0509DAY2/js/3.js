 ...
 *
 *      <a href="#box">zhuTraining</a> 首先会在当前页面URL地址栏末尾设置一个HASH值，浏览器检测到HASH值后，会默认定位到当前页面中ID和HASH相同的盒子的位置（基于HASH值我们还可以实现SPA单页面应用）
 *
 *   INPUT标签也有自己的默认行为
 *      1.输入内容可以呈现到文本框中
...
/*
 * 在结构中阻止
 *   <a href="javascript:;">zhuTraining最新全栈视频，等你来拿~~</a>
