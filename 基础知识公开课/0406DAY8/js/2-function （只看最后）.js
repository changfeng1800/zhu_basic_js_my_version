...
fn(10, 20);
console.log(total);//=>Uncaught ReferenceError: total is not defined TOTAL是私有变量,我们无法在函数的外面直接获取这个值(这是闭包机制)
*/
...
// typeof n=='undefined' 真实项目中开发者更喜欢这种判断模式 typeof null => object 、typeof undefined => undefined

// total=0; 0是有值的,值是0,从内存方面来说，会在栈内存中占一个位置
// total=null;  开发者更喜欢用null来作为初始值,null是空对象指针，是不占内存位置的
// var total;  total === undefined